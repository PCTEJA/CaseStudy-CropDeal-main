...
* The original package name 'com.springbootmicroservices.discovery-server' is invalid and this project uses 'com.springbootmicroservices.discoveryserver' instead.
